...
urlpatterns = [
    ...
    path("api/v1/scheduling/", include("intelligent_scheduling.urls")),
    path("api/v1/analytics/", include("predictive_analytics.urls")),
    path("api/v1/support/", include("automated_support.urls")),
    path("api/v1/smart-orders/", include("smart_orders.urls")),
